...
public class ChocolateImplement implements ChocolateD{
	...
	public void readbyID() {
		...
		String password="Aishusushma@57";
		 ...
		 String readbyID="SELECT*FROM  chocolates order by ID";
		try {
		...
		ResultSet resultSet=statement.executeQuery(readbyID); 
		//boolean isRowPresent=resultSet.next();
		//while(isRowPresent)
		while(resultSet.next()) 
	...
	@Override
	public void readbyREVIEW() {
		String url="jdbc:mysql://localhost:3306/CHOCOLATE";
		String userName="root";
		String password="Aishusushma@57";

		 String readbyREVIEW="SELECT*FROM  chocolates order by REVIEW";
		try {
	...
	@Override
	public void readybyNAME() {
		String url="jdbc:mysql://localhost:3306/CHOCOLATE";
		String userName="root";
		String password="Aishusushma@57";

		 String readbyNAME="SELECT*FROM  chocolates order by NAME";
		try {
		...
		ResultSet resultSet=statement.executeQuery(readbyNAME); 
		//boolean isRowPresent=resultSet.next();
		//while(isRowPresent)
		while(resultSet.next()) 
